...
public class ItemInHand : MonoBehaviour
{
    ...
    public Sprite dirt, grass, stone, endblock, water, sand, door, coal_ore, iron_ore, wood, leaves, treva, rose, ruby_ore, ruby, iron, coal, apple, apple_eaten, apple_seeds, nothing;
